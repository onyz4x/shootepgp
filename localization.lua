...
L:RegisterTranslations("zhCN", function() return {
  ...
  ["Winning Mainspec Bid: %s (%.03f PR)"] = "主天赋竞标获胜: %s (%.03f PR)",
...
完成后打印结果.]],
  ...
  ["Whisper %s a + for %s (mainspec)"] = "%s发起%s的竞拍，请在团队频道输入“需”或“贪”",
  ["Whisper %s a - for %s (offspec)"] = "%s发起%s的竞拍，请在团队频道输入“需”或“贪”",
  ["Whisper %s a + or - for %s (mainspec or offspec)"] = "%s发起%s的竞拍，请在团队频道输入“需”或“贪”",
  ...
  ["Awarding %d GP to %s%s. (Previous: %d, New: %d)"] = "奖励 %d GP 给 %s%s. (以前: %d, 新: %d)",
  ...
  ["Set your main to be able to participate in Reserve List EPGP Checks."] = "设定你的大号到参与替补成员EPGP检查清单.",  
  ...
  ["Need MasterLooter to perform Bid Calls!"] = "需要队长拾取才能调用竞拍!",
